...
from rssynthesis.ui import list_feeds, list_entries
...
def list_entries_by_feed(feed_id: str, request: Request):
    ...
    return templates.TemplateResponse(
        "entries.html", {"request": request, "entries": list(list_entries(feed_id=feed_id))}
    )
...
def list_all_entries(request: Request):
    ...
    return templates.TemplateResponse(
        "entries.html", {"request": request, "entries": list(list_entries(feed_id=None))}
    )
